...
После конфигурации можно запустить файл `experiment.py` и готово! Несколько правил:
 ...
 - Если видите, что результаты очень плачевные или просто странные, то при запросе сохранить модель на сервер, лучше воздержаться, чтобы сохранить время и память.