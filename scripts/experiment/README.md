...
Скачиваем датасет и распаковываем в `datasets/`:

[Ссылка на kaggle датасет](https://www.kaggle.com/datasets/caseyjohnsonrs/pipeline-defects-semantic-segmentation)
